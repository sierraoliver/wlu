...
public class A01Main {
	...
	Object[][] testData = { { 1900, false }, { 1996, true }, { 1999, false }, { 2000, true }, { 1600, true },
		{ 1700, false } };
	...
	Object[][] testData = { { 7, true }, { 5, true }, { 9, false }, { 0, false } };
	...
	Object[][] testData = { { "ABC", 0, "ABC" }, { "ABC", 3, "DEF" }, { "ABC", 30, "EFG" }, { "ZAB", 1, "ABC" } };
     ...
     * Test validSnFile
     */
    private static void testValidSnFile() {
	Scanner source = null;
	final File file = new File("src/cp213/serialNumberFile.txt");
	final File goodSns = new File("src/cp213/goodSns");
	final File badSns = new File("src/cp213/badSns");

	PrintStream good = null;
	PrintStream bad = null;

	try {
	    // Create a file scanner.
	    source = new Scanner(file);
	    good = new PrintStream(goodSns);
	    bad = new PrintStream(badSns);
	} catch (FileNotFoundException e) {
	    e.printStackTrace();
	    System.exit(0);
	}

	SerialNumber.validSnFile(source, good, bad);
