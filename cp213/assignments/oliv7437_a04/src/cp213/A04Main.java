...
public class A04Main {
    ...
    private static final Integer[] testData = { 6, 2, 8, 0, 4, 3, 5 };
	...
	source.remove(source.root.getData());
	System.out.println("  Remove {2:1} from Tree: " + source.levelOrder());
	System.out.println(LINE);
	System.out.println();
    }
	...
	System.out.println("  Equals {false}: " + source.equals(target));
	System.out.println("  isEmpty {false}: " + source.isEmpty());
	...
	source.remove(source.root.getData());
	System.out.println("  Remove {1:1} from Tree: " + source.levelOrder());
	System.out.println(LINE);
	System.out.println();
    }
	...
	System.out.println("  Height {3}: " + source.getHeight());
	source.remove(source.root.getData());
	System.out.println("  Remove {3:1} from Tree: " + source.levelOrder());
	System.out.println(LINE);
	System.out.println();
    }
