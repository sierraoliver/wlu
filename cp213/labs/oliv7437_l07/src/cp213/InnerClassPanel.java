...
public class InnerClassPanel extends JPanel {
	...
	public void itemStateChanged(final ItemEvent e) {
		...
		InnerClassPanel.this.checkBoxesSelected.add(source.getText());
	    } else {
		InnerClassPanel.this.checkBoxesSelected.remove(source.getText());
	    }
	    InnerClassPanel.this.label.setText(InnerClassPanel.this.CheckBoxesSelectedToString());
	    System.out.println(InnerClassPanel.this.CheckBoxesSelectedToString());
	...
	public void stateChanged(final ChangeEvent e) {
		...
		InnerClassPanel.this.label.setText(String.valueOf(InnerClassPanel.this.getSliderSet()));
		System.out.println(InnerClassPanel.this.getSliderSet());
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    InnerClassPanel.this.spinnerSet = String.valueOf(source.getValue());
