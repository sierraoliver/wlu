...
public class RTSameView extends JPanel {
	...
	public void actionPerformed(final ActionEvent evt) {
	    if (this.direction == 0) {
		double newValue = (RTSameView.this.model.getBase() + RTSameView.this.model.getHeight()) / 2;
		RTSameView.this.model.setBase(newValue);
		RTSameView.this.model.setHeight(newValue);
	    } else {
	...
	public void propertyChange(final PropertyChangeEvent evt) {
	    ...
	    if (base == height) {
		RTSameView.this.baseHeight.setText(RTSameView.DECIMAL_FORMAT.format(RTSameView.this.model.getBase()));
	    } else {
