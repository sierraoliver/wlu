...
//=====================================================
/* comments
the returned pc at the end of isLetter is incorrect
specifically bx lr, does not return the correct location to the pc
this is because the lr that is to be returned gets overwritten 
