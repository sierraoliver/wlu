...
//check if start and end of the char have past each other
cmp r5, r4
movle r0, #1
ble _Palindrome

//shift start if not letter
ldrb r2, [r4]
bl isLetter // check if letter
cmp r0, #0
addeq r4,r4,#1
bleq Palindrome //if not letter get next
beq _Palindrome

//shift end if not letter
ldrb r2, [r5]
bl isLetter
cmp r0, #0
subeq r5,r5,#1
